...
def parse_args():
    ...
    parser.add_argument('--input_w', default=512, type=int, help='image width(default: 256)')
    parser.add_argument('--input_h', default=512, type=int, help='image height(default: 256)')
